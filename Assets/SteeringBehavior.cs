...
public class SteeringBehavior : MonoBehaviour
{
    ...
    [HideInInspector]
    public Vector3 force, aceleration, velocity;
    ...
    void FixedUpdate()
    {
        if (enabled)
        {
            ...
            velocity += aceleration * Time.fixedDeltaTime * Time.deltaTime ;
            if (velocity.magnitude > maxVelocity)
                velocity = velocity.normalized * Time.fixedDeltaTime * Time.deltaTime;
